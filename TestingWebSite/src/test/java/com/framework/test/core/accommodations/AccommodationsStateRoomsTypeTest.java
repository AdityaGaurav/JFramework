...
public class AccommodationsStateRoomsTypeTest extends BaseTest
{

	//region AccommodationsTest - Variables Declaration and Initialization Section.

	private static final Logger logger = LoggerFactory.getLogger( AccommodationsStateRoomsTypeTest.class );
	...
	private AccommodationsStateRoomsTypeTest()
	{
		BaseTest.classLogger = LoggerFactory.getLogger( AccommodationsStateRoomsTypeTest.class );
	}
