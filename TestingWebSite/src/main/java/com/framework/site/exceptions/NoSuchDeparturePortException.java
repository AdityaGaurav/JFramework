...
public class NoSuchDeparturePortException extends ObjectApplicationNotFoundException
{
	private static final long serialVersionUID = 7978996500317505389L;

	public NoSuchDeparturePortException( final WebDriver driver, final String message )
	{
