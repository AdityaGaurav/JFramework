...
public class DiningPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/dining";

	private static final String PAGE_TITLE_KEY = "dining.title";
	...
	public DiningPage( final WebDriver driver )
	{
