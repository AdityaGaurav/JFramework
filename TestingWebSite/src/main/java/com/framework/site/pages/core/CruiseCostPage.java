...
public class CruiseCostPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/how-much-does-a-cruise-cost.aspx";

	private static final String PAGE_TITLE_KEY = "cruise.cost.title";
	...
	public CruiseCostPage( final WebDriver driver )
	{
