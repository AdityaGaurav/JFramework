...
public class FaqPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/core/faq.aspx";

	private static final String PAGE_TITLE_KEY = "faq.title";
	...
	public FaqPage( final WebDriver driver )
	{
