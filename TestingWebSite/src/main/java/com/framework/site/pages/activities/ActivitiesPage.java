...
public class ActivitiesPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/Activities";

	private static final String PAGE_TITLE_KEY = "shore.excursions.title";
