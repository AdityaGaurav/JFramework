...
public class VifpClubPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/loyalty/overview.aspx";

	private static final String PAGE_TITLE_KEY = "vifp.club.title";
	...
	public VifpClubPage( final WebDriver driver )
	{
