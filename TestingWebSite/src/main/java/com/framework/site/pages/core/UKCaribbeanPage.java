...
public class UKCaribbeanPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/uk-caribbean.aspx";

	private static final String PAGE_TITLE_KEY = "uk.caribbean.title";
	...
	public UKCaribbeanPage( final WebDriver driver )
	{
