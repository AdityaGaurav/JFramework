...
public class CloseToHomePage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/core/closetohome.aspx";

	private static final String PAGE_TITLE_KEY = "find.a.port.title";
	...
	public CloseToHomePage( final WebDriver driver )
	{
