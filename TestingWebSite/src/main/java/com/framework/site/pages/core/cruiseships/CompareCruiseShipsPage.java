...
public class CompareCruiseShipsPage extends CarnivalPage
{
	...
	private static final String LOGICAL_NAME = "Compare Cruise Ships Page";

	private static final String URL_PATH = "/cruise-ships/compare-cruise-ships";

	private static final String PAGE_TITLE_KEY = "compare.cruise.ships.title";
	...
	public CompareCruiseShipsPage( final WebDriver driver )
	{
