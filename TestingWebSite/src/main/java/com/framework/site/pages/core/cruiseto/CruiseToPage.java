...
public class CruiseToPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/cruise-to.aspx";

	private static final String PAGE_TITLE_KEY = "cruise.to.title";
	...
	public CruiseToPage( final WebDriver driver )
	{
