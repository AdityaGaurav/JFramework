...
public class OnboardActivitiesPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/onboard.aspx";

	private static final String PAGE_TITLE_KEY = "onboard.activities.title";
	...
	public OnboardActivitiesPage( final WebDriver driver )
	{
