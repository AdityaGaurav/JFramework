...
public class CruisingPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/cruising.aspx";

	private static final String PAGE_TITLE_KEY = "cruising.page.title";
	...
	public CruisingPage( final WebDriver driver )
	{
