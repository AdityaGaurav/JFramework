...
public class BookedGuestLogonPage extends CarnivalPage
{
	...
	private static final String URL_PATH = "/BookedGuest/GuestManagement/MyCarnival/LogOn";

	private static final String PAGE_TITLE_KEY = "booked.guest.logon.title";
	...
	public BookedGuestLogonPage( final WebDriver driver )
	{
